...
public class AdminCinemaRoomPage extends javax.swing.JFrame
{

    public AdminCinemaRoomPage()
    {
        initComponents();
    ...
    {//GEN-FIRST:event_deleteBtnMouseClicked
        c.setDelete(txtRoomId, txtRoomNo, txtSeats);
        c.tableLoad(cinemaRoomTable);
    }//GEN-LAST:event_deleteBtnMouseClicked

    private void updateBtnMouseClicked()
    {//GEN-FIRST:event_updateBtnMouseClicked
        c.setUpdate(txtRoomId, txtRoomNo, txtSeats);
        c.tableLoad(cinemaRoomTable);
    ...
    {
        java.awt.EventQueue.invokeLater(() -> new AdminCinemaRoomPage().setVisible(true));
    }
