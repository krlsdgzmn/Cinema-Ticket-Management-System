...
public class CashierSchedulePage extends javax.swing.JFrame {

    public CashierSchedulePage() {
        initComponents();
    ...
    public static void main() {
        java.awt.EventQueue.invokeLater(() -> new CashierSchedulePage().setVisible(true));
    }
