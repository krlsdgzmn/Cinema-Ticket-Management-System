...
public class CashierMoviePage extends javax.swing.JFrame
{
    public CashierMoviePage()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        getContentPane().add(saveBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 610, -1, -1));
    ...
    {
        java.awt.EventQueue.invokeLater(() -> new CashierMoviePage().setVisible(true));
    }
